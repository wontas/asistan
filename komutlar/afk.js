...
.setTitle(`Uyarı`)
.setColor("#5865f2")
.setDescription(`<:reddet:933625465766301728> **AFK Moduna Geçmek İçin Bir Sebep Belirtmelisin!** `))
  ...
  message.channel.send(dcs15).then(sunucu => {
    sunucu.react("<:onayla:933625466189910056>").then(() => sunucu.react("<:reddet:933625465766301728>"));
    ...
    yes.on("collect", r => {
      ...
      let dcs16 = new Discord.MessageEmbed()
        .setTitle(`<:onayla:933625466189910056>** İşlem Başarılı!**`)
