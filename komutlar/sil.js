...
exports.run = (client, message, args) => {
 ...
 message.channel.send(`<a:onaylandi:698113364026720267> Başarılı Bir Şekilde **${miktar}** Mesaj Silindi.`).then(msg => {msg.delete({ timeout: 5000 })}).catch(err => { 
   ...
   if(!sayı || isNaN(sayı)) {
	...
	.setColor("#5865f2")
	.setDescription(`<:reddet:901475681035235349> **Eğer mesajları silmemi istiyorsan lütfen silinicek mesaj miktarını belirt!**`)
   ...
   if(sayı > 100) {
	  const embed = new Discord.MessageEmbed()
	.setColor("#5865f2")
	.setDescription(`<:reddet:901475681035235349> **Üzgünüm ancak Discord kurallarına göre 100'den fazla mesaj silemem!**`)
   ...
   const embed = new Discord.MessageEmbed()
	.setColor("#5865f2")
	.setDescription(`<:onayla:901475681010085928> **Başarılı bir şekilde **${sayı}** Adet mesaj sildim!**`)
	.setFooter(message.author.ag, message.author.avatarURL({ dynamic: true }))
